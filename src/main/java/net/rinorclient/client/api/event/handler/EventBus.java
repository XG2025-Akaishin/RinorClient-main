package net.rinorclient.client.api.event.handler;
...
import net.rinorclient.client.api.event.listener.Listener;
 ...
 * @see Event
 * @see EventHandler
 * @see net.rinorclient.client.api.event.listener.EventListener
 * @see Listener
 * @since 1.0
 */
public class EventBus implements EventHandler {
     ...
     * {@link net.rinorclient.client.api.event.listener.EventListener} in the class to the active listener map.
     *
