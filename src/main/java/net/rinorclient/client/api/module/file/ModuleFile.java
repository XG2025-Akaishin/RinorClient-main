package net.rinorclient.client.api.module.file;

import com.google.gson.JsonObject;

import net.rinorclient.client.Rinor;
import net.rinorclient.client.api.file.ConfigFile;
...
public class ModuleFile extends ConfigFile {
    ...
    public void save() {
        ...
        // error writing file
            ...
            Rinor.error("Could not save file for {}!", module.getName());
            e.printStackTrace();
        }
    }
    ...
    public void load() {
        ...
        // error writing file
            ...
            Rinor.error("Could not read file for {}!", module.getName());
            e.printStackTrace();
        }
    }
}
